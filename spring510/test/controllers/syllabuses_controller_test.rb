...
class SyllabusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create syllabus" do
    assert_difference('Syllabus.count') do
      post syllabuses_url, params: { syllabus: { cid: @syllabus.cid, link: @syllabus.link, prof: @syllabus.prof } }
    end
  ...
  test "should update syllabus" do
    patch syllabus_url(@syllabus), params: { syllabus: { cid: @syllabus.cid, link: @syllabus.link, prof: @syllabus.prof } }
